...
%pertenece
    ...
    for h=1:N
        for l=1:N
            if robots(h).clustered && robots(l).clustered && h ~= l && Clustered([robots(h).posicionRect.x,robots(h).posicionRect.y],[robots(l).posicionRect.x,robots(l).posicionRect.y],10) > 0
