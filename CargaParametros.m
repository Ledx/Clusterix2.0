...
%Carga de los parametros iniciales de entrada
  ...
  REPETICIONES= 2;              %Numero de experimentos a realizar
  ITERACIONES = 300;           %Numero de iteraciones por experimento
  ...
  W=[1 0 0 0 0 0 0 0 0];        %Pesos de las distintas frecuencias
